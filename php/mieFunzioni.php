...
function aggiungiOggetto($descrizione, $oggetto_nome, $categoria){

	$sql_ins="insert into item(Nome, Categoria, Descrizione) values ('".$oggetto_nome."', '".$categoria."', '".$descrizione."');";
	$rs_ins=mysql_query($sql_ins);
...
function aggiungiOggetto2($descrizione, $oggetto_nome, $categoria, $quantita){

	$sql_ins="insert into item(Nome, Categoria, Descrizione, Quantita) values ('".$oggetto_nome."', '".$categoria."', '".$descrizione."', '".$quantita."');";
	$rs_ins=mysql_query($sql_ins);
